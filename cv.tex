...
\section{EXPERIENCE}
\cventry{May 2020 - Present}{Google Summer of Code}{}{}{}
{My proposal, "Computer Vision Based PPI Tool Version 2.0", under the Mifos Initiative was accepted for Google Summer of Code 2020. Over the summer I will work on training models to accurately detect and classify objects in household environments and build an Android app to leverage Cloud Vision to use the trained models and automatically fill PPI surveys.}
...
\cvlistitem{Got selected for \textbf{Hack The North 2019}, Canada's biggest Hackathon, held at the University of Waterloo(travel funding provided)}
...
\cvlistitem{\textbf{Amrita inCTF:} Amrita inCTF is India's biggest Capture the Flag contest held by team bi0s, India's top cyber security team, at my college. I was responsible for event management and organization for the event.}
\cvlistitem{\textbf{MLH Local Hack Day:} This is a series of 3 events spanning across one academic  year of college. I have successfully organized Learn and Build events which were very well received.}
